# this script runs image segmentation of dataset based by transfer learning
...
trainsize=len(get_amseg_dicts("../data/train",classes))
cfg.DATASETS.TEST=()
...
dataset_dicts=get_amseg_dicts("../data/validate",classes)
