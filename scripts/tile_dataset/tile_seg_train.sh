...
#SBATCH --output=img_seg_ballo.%j.out     # Standard output log
#SBATCH --error=img_seg_ballo.%j.err      # Standard error log
...
time python tile_seg_train.py 1>> ./testmodel.${SLURM_JOB_ID}.out 2>> ./testmodel.${SLURM_JOB_ID}.err
